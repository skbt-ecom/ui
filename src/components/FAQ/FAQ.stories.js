  ...
  .add('Default', () => (
    <>
      <FAQBlock>
        ...
        <FAQAnswer>
          Быстро и&nbsp;бесплатно открыть расчетный счет можно
          в&nbsp;Совкомбанке. Оставьте заявку, в&nbsp;течение трех минут
          с&nbsp;вами свяжется сотрудник банка, сообщит всю требуемую информацию
          и&nbsp;зарезервирует расчетный счет, который уже можно сообщить своим
          контрагентам.
        </FAQAnswer>
      </FAQBlock>
      <FAQBlock>
