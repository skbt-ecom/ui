...
var inputComponent = _react["default"].memo(function (props) {
  console.table(props);
  ...
  return _react["default"].createElement(_reactImask.IMaskInput, _extends({}, props, {
    onChange: onChange,
    mask: Number,
    value: console.log('props.value', props.value) || props.value ? String(props.value) : '',
    thousandsSeparator: ' ' // onAccept={(value, mask) =>
...
var SliderComponent = _react["default"].memo(function (props) {
  ...
  var handleInputChange = function handleInputChange(value) {
    console.log('handle value', value, _typeof(value));
  ...
  return _react["default"].createElement("div", {
    ...
    max: 2000
  }), _react["default"].createElement("br", null), _react["default"].createElement("br", null), _react["default"].createElement(_TextField["default"], {
    value: value,
    variant: "outlined",
    margin: "dense" // onChange={handleInputChange}
    // inputProps={{
