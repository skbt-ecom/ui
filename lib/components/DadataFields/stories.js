...
var DadataAddressFlatWrapper = function DadataAddressFlatWrapper(props) {
  ...
  return /*#__PURE__*/_react["default"].createElement(_DadataAddressFlat["default"], {
...
(0, _react2.storiesOf)('DadataFields', module).addDecorator((0, _storybookAddonMaterialUi.muiTheme)([_theme["default"]])).add('Адрес', function () {
  return /*#__PURE__*/_react["default"].createElement(_DadataAddress["default"], {
    onBlur: (0, _addonActions.action)('onBlur'),
    label: 'Адрес',
    dadataOptions: {},
    fullWidth: true
  ...
  return /*#__PURE__*/_react["default"].createElement(_DadataFio["default"], {
    onBlur: (0, _addonActions.action)('onBlur'),
    label: 'ФИО',
    fullWidth: true
  });
}).add('Адрес с кв', function () {
  return /*#__PURE__*/_react["default"].createElement(DadataAddressFlatWrapper, null);
});