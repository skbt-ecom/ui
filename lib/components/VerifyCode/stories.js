...
(0, _react2.storiesOf)('VerifyCode', module).addDecorator((0, _storybookAddonMaterialUi.muiTheme)([_themeHalva["default"]])).add('Timer', function () {
  return _react["default"].createElement(_VerifyCode["default"], {
    ...
    error: true,
    helperText: _react["default"].createElement(_Typography["default"], {
      variant: "caption"
    }, "\u041E\u0442\u043F\u0440\u0430\u0432\u0438\u0442\u044C \u043A\u043E\u0434 \u043F\u043E\u0432\u0442\u043E\u0440\u043D\u043E \u0447\u0435\u0440\u0435\u0437 ", _react["default"].createElement("strong", null, "25 \u0441\u0435\u043A"))
  });
}).add('Link', function () {
  return _react["default"].createElement(_VerifyCode["default"], {
    onChange: (0, _addonActions.action)('onChange'),
    error: true,
    helperText: _react["default"].createElement(_Link["default"], {
