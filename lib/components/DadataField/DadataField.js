...
var _default = _react["default"].memo(function IntegrationAutosuggest(props) {
  ...
  var setDebouncedSuggestions = (0, _react.useRef)((0, _debounce["default"])(function (inputValue) {
    var type = props.type,
  ...
  var onSuggestionSelected = function onSuggestionSelected(event, _ref5) {
    ...
    if (type === 'address') {
      setIsLoading(true);
      return (0, _getDadata["default"])(type, suggestion.unrestricted_value, _objectSpread({}, dadataOptions, {
        count: 1,
        restrict_value: true
      })).then(function (res) {
        var fullSuggestion = res && res.suggestions && res.suggestions[0];
  ...
  var onBlur = function onBlur(e) {
    ...
    if (type === 'fio') {
      if (!isSuggestionSelected.current) {
        var _value = state.single ? state.single.trim() : null;
