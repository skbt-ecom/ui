...
var renderCheckboxItem = function renderCheckboxItem(_ref, handleChange, index, classes, color) {
...
var CheckboxGroup = _react["default"].memo(function (props) {
  ...
  return _react["default"].createElement(_FormControl["default"], {
    ...
    return renderCheckboxItem(option, handleChange, index, classes, color);
