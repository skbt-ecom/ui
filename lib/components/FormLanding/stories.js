...
var _AutosuggestField = _interopRequireDefault(require("./fields/AutosuggestField"));
...
(0, _react2.storiesOf)('FormLanding', module).addDecorator((0, _storybookAddonMaterialUi.muiTheme)([_theme["default"]])).add('Default', function () {
  return _react["default"].createElement(_FormLanding["default"], {
    ...
    name: 'email',
    label: 'email'
  }), _react["default"].createElement(_AutosuggestField["default"], {
    name: 'autosuggest',
    suggestions: AUTOSUGGEST_ITEMS
