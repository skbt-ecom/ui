  ...
  function Form() {
    ...
    _defineProperty(_assertThisInitialized(_this), "registerField", function (_ref) {
      ...
      _this.setState(function (state) {
        return {
          fields: _objectSpread(_objectSpread({}, state.fields), {}, _defineProperty({}, fieldKey, {
            value: value,
            validate: validate,
            touched: false,
    ...
    _defineProperty(_assertThisInitialized(_this), "setField", function (fieldKey, data) {
      ...
      _this.setState(function (state) {
        return {
          fields: _objectSpread(_objectSpread({}, state.fields), {}, _defineProperty({}, fieldKey, newField))
        };
      });
    });
    ...
    _defineProperty(_assertThisInitialized(_this), "onChange", function (_ref2) {
      ...
      var nextFields = _objectSpread(_objectSpread({}, _this.state.fields), {}, _defineProperty({}, fieldKey, nextField));
