...
if (process.env.NODE_ENV !== 'production') {
  console.error('⚠️ Deprecation component "DadataField" ⚠️\n ⚠️ Use the "DadataFields/Dadata*.js" instead ⚠️');
}

var fioDefaultProps = {
  label: 'Фамилия Имя Отчество',
  validate: _validators.fioValidator
};
var addressDefaultProps = {
  label: 'Адрес',
  name: 'address',
  validate: _validators.addressValidator
};

var DadataField = /*#__PURE__*/_react["default"].memo(function (props) {
  return /*#__PURE__*/_react["default"].createElement(_DadataField["default"], props);
});
...
var WrappedField = function WrappedField(_ref) {
  ...
  }, /*#__PURE__*/_react["default"].createElement(_Field.Field, (0, _extends2["default"])({}, propsByType, props, {
