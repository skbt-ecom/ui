...
var DateField = _react["default"].memo(function (props) {
  return /*#__PURE__*/_react["default"].createElement(_DateField["default"], props);
});
...
var WrappedField = function WrappedField(_ref) {
  var validAgeMin = _ref.validAgeMin,
      ...
      props = _objectWithoutProperties(_ref, ["validAgeMin", "validAgeMax", "classsesComponent"]);
  ...
  }, /*#__PURE__*/_react["default"].createElement(_Field.Field, _extends({
    validate: validator
  }, props, {
