...
var AutosuggestFieldWrapper = function AutosuggestFieldWrapper(props) {
  ...
  return _react["default"].createElement(_react["default"].Fragment, null, _react["default"].createElement(_AutocompleteField["default"], (0, _extends2["default"])({}, props, {
    onChange: onChange,
    value: value,
    label: 'Регион',
    classes: {
...
(0, _react2.storiesOf)('AutocompleteField', module).addDecorator((0, _storybookAddonMaterialUi.muiTheme)([_theme["default"]])).add('Default', function () {
  return _react["default"].createElement(AutosuggestFieldWrapper, {
